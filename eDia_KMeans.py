...
file = '/Users/tjokro/PycharmProjects/Tjokro/interactive-diary/QnC_V3.xlsx'
...
fake_users_df = pd.DataFrame(np.random.randint(1, 5, size=(150,7)), columns=['Physical Health', 'Feelings',
                'Relationship', 'Self_Reflection', 'Self_Motivation', 'Personal Growth', 'Open topic'])
